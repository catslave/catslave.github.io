...
# RocketMQ.Remoting
Remoting，RocketMQ的通信系统。RocketMQ使用Netty作为底层通信框架，自定义了NettyRemotingServer和NettyRemotingClient两个客户端实例以及NettyRemotingAbstract公共抽象类。<br/>
